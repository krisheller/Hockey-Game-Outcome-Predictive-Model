...
def format_raw_data(type):
    path = os.path.join(os.getcwd(),f'data\moneypuck\{type}')
...
def clean_historical_data():
    ...
    if not(os.path.isfile('data\db.db')):
        ...
        skaters, goalies, teams = format_raw_data('skaters'), format_raw_data('goalies'), format_raw_data('teams')
        #shots = format_raw_data('shots')
        print("Data loaded.")
